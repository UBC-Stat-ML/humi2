...
// prior-sensitivity_10000_100_INF_INF
params.nScans = 10000
params.nInitParticles = 100 // increase this if model initialization fails (can happen in complex mixture models with vague priors)
